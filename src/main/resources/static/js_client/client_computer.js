...
function applyFilters() {
    ...
    const processorFilter = document.getElementById('processorFilter').value;
    ...
    products.forEach(product => {
        ...
        // Type filter
        if (typeFilter && product.dataset.type !== typeFilter) {
            show = false;
        }
        ...
        // RAM filter
        if (ramFilter && product.dataset.ram !== ramFilter) {
            show = false;
        }
                
        // Storage filter
        if (storageFilter && product.dataset.storage !== storageFilter) {
            show = false;
        }
